        ...
        <div class="sidebar-inner">
          ...
          <ul class="sidebar-menu scrollable pos-r">
			...
			<li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="sidebar-link" href="<?php echo site_url('admin/User'); ?>">Add User
                  </a>
                </li>
                <li>
                  <a class="sidebar-link" href="<?php echo site_url('admin/admin/view'); ?>">View User
                  </a>
                </li>
              </ul>
            </li>
              ...
              <li class="dropdown">
                <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                  <div class="peer mR-10">
                    <img width="30px" height="30px" class="w-2r bdrs-50p" src="<?php echo base_url()?>image/<?php
